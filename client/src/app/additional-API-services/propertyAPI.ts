import { PropertyType, PropertyTypeFull } from "../api-types/types";
import handleAuthenticationError from "./auth-router";

const BASE_URL = process.env.SERVER_URL

const checkAddress = async (accesToken: string, propertyData: PropertyType): Promise<PropertyType | PropertyTypeFull> => {
  try {

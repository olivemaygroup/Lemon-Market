...
const signup = (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const userExists = yield prisma.tenant.findUnique({ where: { email: sanitizedEmail } });
        if (userExists) {
...
const login = (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const sanitizedEmail = email.replace(/[$/(){}]/g, "");
    const sanitizedPassword = password.replace(/[$/(){}]/g, "");
    const user = yield prisma.tenant.findUnique({ where: { email: sanitizedEmail } });
    const validatePassword = yield bcrypt.compare(sanitizedPassword, user.password);
    if (!validatePassword) {
